...
public class TechAscendBlockStates extends BlockStateProvider {
    public TechAscendBlockStates(PackOutput packOutput, ExistingFileHelper existingFileHelper) {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(Registration.CHARGER_BLOCK.get());
        registerProcesser();
    }

    private void registerProcesser() {
    ...
    private void createProcessorModel(Block block, String path, BlockModelBuilder base) {
        ...
        for (Direction dir : Direction.values()) {
            ...
            bld.part().modelFile(base).rotationX(rotationX).rotationY(angleOffset).addModel().condition(BlockStateProperties.FACING, dir).end();
